            ...
            stage('docker build & docker push to Nexus repo'){
                steps{
                    script{
                        ...
                        docker push 44.212.71.65:8083/springapp:${VERSION}
            ...
            stage('Pushing the helm charts to nexus repo') {
                steps{
                    script{
                        ...
                        curl -u admin:$nexus_creds http://44.212.71.65:8081/repository/helm-repo/ --upload-file myapp-${helmversion}.tgz -v
                        '''
                    }
                }
                }
